...
static struct luaL_Reg image_f [] = {
  {"new", image_new},
  {"load", image_load},
  {NULL, NULL}
};

static struct luaL_Reg image_m [] = {
...
void l_register(lua_State *L,const char* name,struct luaL_Reg f []) {
  //int size_of_array = sizeof(f)/sizeof(luaL_Reg);
  /*if (name == NULL) {
    lua_pushcfunction(L,f);
    lua_setglobal(L,name);
    //lua_newtable(L);
    //luaL_setfuncs(L, f, 0);
    printf("SET NULL FUNCTIONS");
  }*/
...
int luaopen_array (lua_State *L) {
  ...
  // Stack: MyLib
  luaL_newmetatable(L, "LuaBook.array"); // Stack: MyLib meta
...
int luaopen_limlib(lua_State *L) {
  ...
  luaL_newmetatable(L, "imlib_border");
  lua_pushvalue(L, -1);
  lua_setfield(L, -2, "__index");
  //l_register(L, NULL, border_m);
  l_register(L, "imlib_border", border_f);

  luaL_newmetatable(L, "imlib_color");
  lua_pushvalue(L, -1);
  lua_setfield(L, -2, "__index");
  //l_register(L, NULL, color_m);
  l_register(L, "imlib_color", color_f);

  luaL_newmetatable(L, "imlib_gradient");
  lua_pushvalue(L, -1);
  lua_setfield(L, -2, "__index");
  //l_register(L, NULL, gradient_m);
  l_register(L, "imlib_gradient", gradient_f);

  luaL_newmetatable(L, "imlib_polygon");
  lua_pushvalue(L, -1);
  lua_setfield(L, -2, "__index");
  //l_register(L, NULL, polygon_m);
  l_register(L, "imlib2_polygon", polygon_f);

  luaL_newmetatable(L, "imlib_font");
  lua_pushvalue(L, -1);
  lua_setfield(L, -2, "__index");
  //l_register(L, NULL, font_m);
  l_register(L, "imlib_font", font_f);
...
/*
  ...
  //l_register(L, "image", image_m);
  l_register(L, "image", image_f); //.image
 
  l_register(L, "imlib", f);
*/
